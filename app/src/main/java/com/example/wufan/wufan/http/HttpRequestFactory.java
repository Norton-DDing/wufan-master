package com.example.wufan.wufan.http;

import com.facebook.stetho.okhttp3.StethoInterceptor;
import com.example.wufan.wufan.api.ApiFactory;
import com.example.wufan.wufan.config.Constants;
import com.example.wufan.wufan.http.callback.HttpRequestCallback;
import com.example.wufan.wufan.http.converter.ResponseConverterFactory;
import com.example.wufan.wufan.http.exception.ApiException;
import com.example.wufan.wufan.http.exception.ErrorCode;
import com.example.wufan.wufan.http.exception.ExceptionHandle;
import com.example.wufan.wufan.http.request.BaseRequestParams;
import com.example.wufan.wufan.http.response.HttpResponseData;
import com.example.wufan.wufan.util.XAuthUtils;
